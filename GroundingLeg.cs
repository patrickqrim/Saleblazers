...
namespace RootMotion.FinalIK
{
    ...
    public partial class Grounding
    {
        ...
        public class Leg
        {
            ...
            public Quaternion toHitNormal, r;
            ...
            public void Process()
            {
                ...
                transformPosition = Vector3.Lerp(transformPosition, doOverrideFootPosition ? overrideFootPosition : transform.position, deltaTime * 20.0f);
